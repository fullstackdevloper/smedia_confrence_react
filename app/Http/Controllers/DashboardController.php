...
class DashboardController extends Controller
{
    ...
    public function index() {
        ...
        if(isset($_GET['code'])) {
            ...
            return redirect('/dashboard')->with('success', __('Your calendar has been added.'));
        }
    ...
    public function schedule(Request $request) {
        ...
        if($input){
            ...
            if($model->validate($input)) {
                ...
                if($meetingId) {
                    return redirect('/payment/meeting/'.$meetingId)->with('success', __('Meeting has been scheduled. Please make payment'));;
                }
            }else {
    ...
    public function editMeeting(Request $request, $meeting_id = null) {
        ...
        if($input){
            ...
            if($model->validate($input)) {
                ...
                if($meetingId) {
                    return redirect('/meetings/'.$meetingId)->with('success', __('Meeting has been updated successfully.'));
                }
            }else {
                return Redirect::back()->withErrors($model->errors())->withInput($input);
            }
    ...
    public function delete_meeting(Request $request, $meeting_id = null) {
        ...
        return redirect('/meetings')->with('success', __('Meeting has been deleted successfully.'));;
    }
    ...
    public function settings (Request $request) {
        ...
        if($input) {
            ...
            return redirect('/dashboard/settings')->with('success', __('Settings has been updated successfully.'));;
        }
